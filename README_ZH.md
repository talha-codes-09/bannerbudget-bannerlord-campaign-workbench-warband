...
<!-- readme-locale:zh -->
<div align="center">
<img src="./public/logo.svg" alt="BannerBudget — Mount &amp; Blade II: Bannerlord — Warband" width="64" height="64">
<h1>BannerBudget — Mount &amp; Blade II: Bannerlord — Warband</h1>
</div>

独立的项目设计文档，适用对象： **Mount & Blade II: Bannerlord**。
...
- **队伍经济表** (Party economy sheets) — 规划模块，尚未实现。
- **技能成长场景** (Skill progression scenarios) — 规划模块，尚未实现。
- **战役备份记录** (Campaign backup ledger) — 规划模块，尚未实现。
...
| 字段 | 内容 |
|---|---|
| 适用对象 | Mount & Blade II: Bannerlord |
| 类别 | 本地游戏场景规格 |
| 输入 | 手工记录或用户授权的本地导出 |
| 计划输出 | 队伍经济表 |
| 兼容性 | 未验证；未声明支持任何具体版本 |
